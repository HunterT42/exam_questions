...
var all_questions = [{
    index: 0,
    category: 0,
    name: 'Развитие языков программирования. Обзор языков программирования. Области применения языков программирования.'
  },
  {
    index: 1,
    category: 0,
    name: 'Компиляторы и интерпретаторы. Жизненный цикл программы.'
  },
  {
    index: 2,
    category: 0,
    name: 'Программа. Программный продукт и его характеристики. Основные этапы решения задач на компьютере.'
  },
  {
    index: 3,
    category: 0,
    name: 'Переменные и константы. Объявление объектов данных. Внутреннее представление данных в памяти компьютера.'
  },
  {
    index: 4,
    category: 0,
    name: 'Типы данных. Простые типы данных.'
  },
  {
    index: 5,
    category: 0,
    name: 'Производные типы данных. Структурированные типы данных.'
  },
  {
    index: 6,
    category: 0,
    name: 'Операции и выражения. Правила формирования и вычисления выражений. Структура программы. Ввод и вывод данных.'
  },
  {
    index: 7,
    category: 0,
    name: 'Оператор присваивания. Составной оператор. Условный оператор. Оператор выбора.'
  },
  {
    index: 8,
    category: 0,
    name: 'Понятие условия. Виды условий. Комбинирование различных условий.'
  },
  {
    index: 9,
    category: 0,
    name: 'Понятие цикла. Виды циклов. Цикл с постусловием. Цикл с предусловием. Цикл с параметром. Вложенные циклы.'
  },
  {
    index: 10,
    category: 0,
    name: 'Понятие рекурсии. Пример рекурсии. Отличие рекурсии от вложенных циклов.'
  },
  {
    index: 11,
    category: 0,
    name: 'Функции и методы в программировании. Понятие аргумента. Примеры функций с аргументами и без. Понятие чистой функции.'
  },
  {
    index: 12,
    category: 0,
    name: 'Понятие потока выполнения программы. Понятие прерываний. Влияние прерываний на поток выполнения.'
  },
  {
    index: 13,
    category: 0,
    name: 'Понятие инкремента и декремента. Примеры инкрементации и декрементации значений переменных в программировании.'
  },
  {
    index: 14,
    category: 0,
    name: 'Ошибки в программировании. Виды ошибок. Способы отладки.'
  },
  {
    index: 15,
    category: 0,
    name: 'Итеративный процесс. Понятие итерации. Примеры итераций.'
  },
  {
    index: 16,
    category: 1,
    name: 'Язык JavaScript, история его возникновения. Особенности языка.'
  },
  {
    index: 17,
    category: 1,
    name: 'Что может и чего не может JavaScript в браузере. Какие существую варианты обхода этих ограничений.'
  },
  {
    index: 18,
    category: 1,
    name: 'Понятие скрипт. Написание и исполнение скриптов на JavaScript. Способы интерпретации скриптов, написанных на JavaScript.'
  },
  {
    index: 19,
    category: 1,
    name: 'Переменные и постоянные (константы) в JavaScript. Способы их задать.'
  },
  {
    index: 20,
    category: 1,
    name: 'Ввод и вывод в JavaScript. Как можно вводить данные и куда выводить.'
  },
  {
    index: 21,
    category: 1,
    name: 'Типы данных в JavaScript. Особенности типов данных в JavaScript в отличие от большинства других популярных языков программирования. Преобразование (приведение) типов.'
  },
  {
    index: 22,
    category: 1,
    name: 'Условия в JavaScript, их виды и способы их задать. Вложенные условия, примеры на JavaScript.'
  },
  {
    index: 23,
    category: 1,
    name: 'Циклы в JavaScript, их основные виды и назначение. Отличие вложенного цикла и рекурсии, примеры на JavaScript.'
  },
  {
    index: 24,
    category: 1,
    name: 'Функции в JavaScript, виды функций. Назначение функций в JavaScript. Примеры функций на JavaScript.'
  },
  {
    index: 25,
    category: 1,
    name: 'Способы отладки кода на JavaScript на примере браузера Google Chrome.'
  },
  {
    index: 26,
    category: 2,
...
// var firstQuestion = function (all_questions[].category){
//
// };

for (var i = 0; i < all_questions.length; i++) {
  if (all_questions[i].category == 0) {
    var kek = all_questions[i];
    console.log(kek);
  }
}
